...
function us_united_states_form_shortcode() {
    // HTML form cho form đầu tiên
    $html = '
        <div class="us-united-states-form">
            <h3 class="title-form1">US UNITED STATES</h3>
            <form id="usUnitedStatesForm" action="" method="GET" target="_blank">
                <input type="text" id="trackingNumber" name="trackingNumber" placeholder="Enter tracking number">
                <button class="btn-form1" type="button" onclick="openTrackingUrl()">Find Order</button>
            </form>
        </div>
        <script type="text/javascript">
            function openTrackingUrl() {
                var input = document.getElementById("trackingNumber").value;
                var url = "https://t.17track.net/en?nums=" + input;
                window.open(url, "_blank");
            }
        </script>
    ';

    // HTML form cho form thứ hai
    $html .= '
        <div class="usps-form">
            <h3 class="title-form2">WORLDWIDE</h3>
            <form id="uspsForm" action="" method="GET" target="_blank">
                <input type="text" id="uspsTrackingNumber" name="uspsTrackingNumber" placeholder="Enter USPS tracking number">
                <button class="btn-form2" type="button" onclick="openUSPSUrl()">Find Order</button>
            </form>
        </div>
        <script type="text/javascript">
            function openUSPSUrl() {
                var input = document.getElementById("uspsTrackingNumber").value;
                var url = "https://tools.usps.com/go/TrackConfirmAction?tLabels=" + input;
                window.open(url, "_blank");
            }
        </script>
    ';
...
// Đăng ký shortcode
add_shortcode('us_united_states_form', 'us_united_states_form_shortcode');
